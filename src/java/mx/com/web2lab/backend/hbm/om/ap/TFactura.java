...
public class TFactura implements Serializable {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TFactura) ) return false;
        TFactura castOther = (TFactura) other;
