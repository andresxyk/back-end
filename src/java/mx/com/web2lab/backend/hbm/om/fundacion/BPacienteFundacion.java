...
public class BPacienteFundacion implements Serializable {

    /** identifier field */
    private java.lang.Long kpacientefundacion;

    /** persistent field */
    private long cpacientefundacion;
    ...
    /** persistent field */
    private Set bordenfundacions;

    /** persistent field */
    private Set bpacientecuestionarios;

    /** full constructor */
    public BPacienteFundacion(long cpacientefundacion, java.lang.String snombre, java.lang.String sappaterno, java.lang.String sapmaterno, java.util.Date dnacimiento, java.lang.String sdireccion, java.lang.String scolonia, java.lang.String sdelegmuni, int scodigopostal, java.lang.String stelefono, boolean bregistroactivo, int cusuario, java.util.Date dregistro, int usexo, java.lang.String scorreoelectro, java.lang.String sciudad, Set bordenfundacions, Set bpacientecuestionarios) {
        this.cpacientefundacion = cpacientefundacion;
        ...
        this.bordenfundacions = bordenfundacions;
        this.bpacientecuestionarios = bpacientecuestionarios;
    }

    /** default constructor */
    public BPacienteFundacion() {
    }

    /** minimal constructor */
    public BPacienteFundacion(long cpacientefundacion, java.lang.String snombre, java.lang.String sappaterno, int cusuario, Set bordenfundacions, Set bpacientecuestionarios) {
        this.cpacientefundacion = cpacientefundacion;
        this.snombre = snombre;
        this.sappaterno = sappaterno;
        this.cusuario = cusuario;
    ...
    public java.lang.Long getKpacientefundacion() {
        return this.kpacientefundacion;
    }

    public void setKpacientefundacion(java.lang.Long kpacientefundacion) {
        this.kpacientefundacion = kpacientefundacion;
    }

    public long getCpacientefundacion() {
        return this.cpacientefundacion;
    }

    public void setCpacientefundacion(long cpacientefundacion) {
        this.cpacientefundacion = cpacientefundacion;
    }
    ...
    public java.util.Set getBordenfundacions() {
        return this.bordenfundacions;
    }

    public void setBordenfundacions(java.util.Set bordenfundacions) {
        this.bordenfundacions = bordenfundacions;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this)
            .append("kpacientefundacion", getKpacientefundacion())
            .toString();
    }

    public boolean equals(Object other) {
        if ( !(other instanceof BPacienteFundacion) ) return false;
        BPacienteFundacion castOther = (BPacienteFundacion) other;
        return new EqualsBuilder()
            .append(this.getKpacientefundacion(), castOther.getKpacientefundacion())
            .isEquals();
    }

    public int hashCode() {
        return new HashCodeBuilder()
            .append(getKpacientefundacion())
            .toHashCode();
    }
