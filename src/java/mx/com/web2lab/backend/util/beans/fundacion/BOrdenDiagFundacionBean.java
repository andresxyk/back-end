...
public class BOrdenDiagFundacionBean implements Serializable {

    /** identifier field */
    private int kordendiagfundacion;

    /** identifier field */
    private int kordenfundacion;
    ...
    /** default constructor */
    public BOrdenDiagFundacionBean() {
    }

    public int getKordendiagfundacion() {
        return this.kordendiagfundacion;
    }

    public void setKordendiagfundacion(int kordendiagfundacion) {
    ...
    public int getKordenfundacion() {
        return this.kordenfundacion;
    }

    public void setKordenfundacion(int kordenfundacion) {
    ...
    public String getObject() {
    	return "kordendiagfundacion" + kordendiagfundacion +
    	"kordenfundacion" + kordenfundacion +
    	"svulvarotros" + svulvarotros +
    	"ctiposbiopsia" + ctiposbiopsia +
    	"bvulvaberruga" + bvulvaberruga +
    	"bvulvabartho" + bvulvabartho +
    	"bvulvapapilomatosis" + bvulvapapilomatosis +
    	"bvulvamolusco" + bvulvamolusco +
    	"bvulvanevos" + bvulvanevos +
    	"bvulvaquiste" + bvulvaquiste +
    	"bvulvavph" + bvulvavph +
    	"cvulvitis" + cvulvitis +
    	"bvulvaacuminada" + bvulvaacuminada +
    	"bvulvaperianal" + bvulvaperianal +
    	"bvulvavaginal" + bvulvavaginal +
    	"bvulvavulvar" + bvulvavulvar +
    	"catrifia" + catrifia +
    	"bvulvafolicutilits" + bvulvafolicutilits +
    	"ccervix" + ccervix +
    	...
    	"bsecrecionfluida" + bsecrecionfluida +
    	"bsecrecionespesa" + bsecrecionespesa +
    	"bsecrecionsemiespesa" + bsecrecionsemiespesa +
    	"bsecreciongrumosa" + bsecreciongrumosa +
    	"bsecrecionespumosa" + bsecrecionespumosa +
    	"bsecrecionescasa" + bsecrecionescasa +
    	"bsecrecionmoderada" + bsecrecionmoderada +
    	"bsecrecionabundante" + bsecrecionabundante +
    	"cdiu" + cdiu +
    	...
    	"cpolipo" + cpolipo +
    	"utamanopolipo" + utamanopolipo +
    	"bprocesoerosivo" + bprocesoerosivo +
    	"bmei" + bmei +
    	"bmeipo" + bmeipo +
    	"bquistenaboth" + bquistenaboth +
    	"squistenaboth" + squistenaboth +
    	"bcolposano" + bcolposano +
    	"bcolpoleibg" + bcolpoleibg +
    	"bcolpoleiag" + bcolpoleiag +
    	"bcolpocancer" + bcolpocancer +
    	"bcolpobacteriana" + bcolpobacteriana +
    	"bcolpomicotica" + bcolpomicotica +
    	"bcolpoparasitaria" + bcolpoparasitaria +
    	"bcolpomiomaedocervical" + bcolpomiomaedocervical +
    	"bcolpocondilomatosis" + bcolpocondilomatosis +
    	"cmucosaatrofica" + cmucosaatrofica +
    	"cpolipovagino" + cpolipovagino +
    	"upolipovaginotamano" + upolipovaginotamano +
    	"cmucosaatroficavagino" + cmucosaatroficavagino +
    	"cvaginosisvagino" + cvaginosisvagino +
    	"bvaginoscoacuminado" + bvaginoscoacuminado +
    	"bvaginosconiva" + bvaginosconiva +
    	"bvaginoscogranuloma" + bvaginoscogranuloma +
    	"bpapaleibg" + bpapaleibg +
    	"bpapaleiag" + bpapaleiag +
    	"bpapacarciinsitu" + bpapacarciinsitu +
    	"bpapacarcimicroinvasor" + bpapacarcimicroinvasor +
    	"bpapacarcinomainvasor" + bpapacarcinomainvasor +
    	"bpapaadenoinsitu" + bpapaadenoinsitu +
    	"bpapaadenoinvasor" + bpapaadenoinvasor +
    	"bpapacarciepidermoide" + bpapacarciepidermoide +
    	"bpapaascus" + bpapaascus +
    	"bpapaasch" + bpapaasch +
    	"bpapacandida" + bpapacandida +
    	"bpapatrichomona" + bpapatrichomona +
    	"bpapaactinomyces" + bpapaactinomyces +
    	"bpapavaginosis" + bpapavaginosis +
    	"bcervixleibg" + bcervixleibg +
    	"bcervixleiag" + bcervixleiag +
    	"bcervixcarciinsitu" + bcervixcarciinsitu +
    	"bcervixcarcimicroinvasor" + bcervixcarcimicroinvasor +
    	"bcervixcarciinvasor" + bcervixcarciinvasor +
    	"bcervixadenoinsitu" + bcervixadenoinsitu +
    	"bcervixadenoinvasor" + bcervixadenoinvasor +
    	"bcervixcarciepidermoide" + bcervixcarciepidermoide +
    	"bcervixcondilom    " + bcervixcondilom     +
    	"bcervixpolipo    " + bcervixpolipo     +
    	"bcervixaguda    " + bcervixaguda     +
    	"bcervixcronica    " + bcervixcronica     +
    	"bconoleibgsin    " + bconoleibgsin     +
    	"bconoleiagsin    " + bconoleiagsin     +
    	"bconoleibgcon    " + bconoleibgcon     +
    	"bconoleiagcon    " + bconoleiagcon     +
    	"bconocarcinoma    " + bconocarcinoma     +
    	"bconoadenosin    " + bconoadenosin     +
    	"bconoadenocon    " + bconoadenocon     +
    	"bconoadenoinvasor    " + bconoadenoinvasor     +
    	"bconoaguda" + bconoaguda +
    	"bconocronica    " + bconocronica     +
    	"bblandoscondiloma    " + bblandoscondiloma     +
    	"bblandosniva    " + bblandosniva     +
    	"bblandosmoluco    " + bblandosmoluco     +
    	"bblandosberruga    " + bblandosberruga     +
    	"bblandosnevo    " + bblandosnevo     +
    	"bvaginacondiloma" + bvaginacondiloma +
    	"bvaginapolipo    " + bvaginapolipo     +
    	"bvaginaniva    " + bvaginaniva     +
    	"bvaginaproceso" + bvaginaproceso;
    }
}
